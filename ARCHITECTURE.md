...
- `AssetCatalog.BRAND_LOGO` owns the active Home logo mapping at `assets/runtime/ui/majestic_gems_logo_v2.png`; `project.godot` reuses it for the fallback boot splash.
