...
## Deterministic, development-only visual evidence for Purple Production HUD
...
const OUTPUT_DIR := "res://reports/purple-production-hud-v1/"
...
func _run() -> void:
	...
	paused = false
	print("PURPLE_PRODUCTION_HUD_V1_CAPTURE: PASS")
	quit(0)
