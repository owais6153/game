...
## Deterministic, development-only visual evidence for Transparent Purple Glass HUD
...
const OUTPUT_DIR := "res://reports/transparent-purple-glass-hud-v1/"
...
func _run() -> void:
	...
	paused = false
	print("TRANSPARENT_PURPLE_GLASS_HUD_V1_CAPTURE: PASS")
	quit(0)
