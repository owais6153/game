...
const PROGRESSION_TABLE_GAP := 10.0
const TARGET_PROGRESSION_GAP := 18.0
const HUD_ICON_SIZE := 58.0
const PROGRESSION_ICON_SIZE := 54.0
const TARGET_ICON_SIZE := 82.0
const NEXT_ICON_SIZE := 58.0
const HEADER_HEIGHT := 172.0
const UTILITY_ROW_HEIGHT := 116.0
const TOP_UTILITY_HEIGHT := 108.0
const TOP_STATUS_HEIGHT := 72.0
const TOP_ROW_GAP := 10.0
const TOP_HUD_HEIGHT := TOP_UTILITY_HEIGHT + TOP_STATUS_HEIGHT + TOP_ROW_GAP
const PROGRESSION_HEIGHT := 64.0
const OBJECTIVE_GAP := TARGET_PROGRESSION_GAP
const SCORE_PANEL_SIZE := Vector2(176.0, 108.0)
const NEXT_PANEL_SIZE := Vector2(150.0, 108.0)
const TARGET_PANEL_SIZE := Vector2(372.0, 124.0)
