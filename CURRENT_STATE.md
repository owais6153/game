...
- **COLLECT is gated on the star sequence.** It, DOUBLE COINS and HOME stay disabled until the last star has landed - a fast tap on the popup used to be enough to skip an award the player never saw. A loss shows no star row and gates nothing.
