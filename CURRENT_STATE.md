...
- Limited-shot cadence moved off "every third level" to an irregular four-in-thirteen pattern, held near the old density on purpose because limited rounds pay less and a denser cadence deflated coin income ~13%.
- Verified over levels 1-100: all 18 templates used, zero consecutive repeats, zero invalid configurations, coin income rising monotonically by band (322/426/449/467/486) against the old flat ~486. `scripts/dev/print_level_template_audit.gd` reproduces this.
