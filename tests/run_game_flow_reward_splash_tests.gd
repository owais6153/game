...
func _test_controller_flow_guards() -> void:
	...
	_assert(export_source.contains("splash_screen/icon=\"res://assets/runtime/ui/majestic_gems_system_splash_1152_v3.png\""), "Android launch splash must use the dedicated high-resolution derivative")
	...
	var splash := Image.load_from_file(ProjectSettings.globalize_path("res://assets/runtime/ui/majestic_gems_system_splash_1152_v3.png"))
