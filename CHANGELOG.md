...
- Moved limited-shot cadence off "every third level" to an irregular four-in-thirteen pattern with gaps of two to five. Held near the old density deliberately: limited rounds carry shorter target ladders and pay less, and a five-in-thirteen cadence tried first cost about 13% of average coin income before it was corrected.
...
- Verified across levels 1-100: all 18 templates used, no consecutive repeats, no invalid configurations, and coin income rising monotonically by band (322/426/449/467/486) against the old flat ~486.
