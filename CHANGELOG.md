...
- **Level Complete awards the earned stars one at a time**, naming each objective under the row as it lands, and COLLECT, DOUBLE COINS and HOME stay locked until the last one has. Without the gate a fast tap on the popup skipped an award the player never saw. A failed result shows no star row and gates nothing.
