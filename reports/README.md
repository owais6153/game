...
- `POST_ADMOB_REWARD_FLOW_AND_SIZE_FIX.md` — APK regression audit/optimization, explicit reward→Next→Ready→Play flow, AdMob lifecycle safety, package migration, and final verification.
...
- [Level Map Normal Scroll, Brand v7, Asset Purge](LEVEL_MAP_NORMAL_SCROLL_BRAND_V7_REPORT.md) — replaces the hand-rolled level-map flick physics with an ordinary ScrollContainer, ships the v7 illustrated launcher icon, deletes fifteen superseded brand derivatives, and records why three test suites had been reporting PASS with dead cases.
